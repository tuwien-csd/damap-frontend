...
} from '../selectors/repository.selectors';
...
export class RepositoryEffects {
  ...
  constructor(
    ...
    this.loadRecommendedRepositories$ = createEffect(() =>
      this.actions$.pipe(
    ...
    this.loadRepository$ = createEffect(() =>
      this.actions$.pipe(
    ...
    this.searchRepositoriesByQuery$ = createEffect(
      () =>
        ({
